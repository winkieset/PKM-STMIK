...
<head>
  <meta charset="utf-8">
  <title>LOGIN - Website Pengajuan PKM</title>
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <form method="post" action="<?php echo base_url() . 'welcome/login' ?>">
          ...
          <div class="form-group">
            <a href="<?php echo base_url() . 'welcome/tambah_mahasiswa' ?>" class="btn btn-success btn-user btn-block">REGISTER</a>
          </div>
        </form>
        <br><br>
      </div>
