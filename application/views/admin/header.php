...
<head>
  <title>Dashboard - Aplikasi PKM</title>
  ...
  <nav class="navbar navbar-default">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo base_url() . 'admin'; ?>">WEBSITE PENGAJUAN PKM</a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li><a href="<?php echo base_url() . 'admin/pengajuan'; ?>"><i class="glyphicon glyphicon-folder-open"></i>Data Pengajuan</a></li>
          <li><a href="<?php echo base_url() . 'admin/mahasiswa'; ?>"><i class="glyphicon glyphicon-user"></i>Data mahasiswa</a></li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a href="<?php echo base_url() . 'admin/cetak_laporan_pengajuan' ?>">
                  <i class="glyphicon glyphicon-list-all"></i>Laporan Data Pengajuan
                </a>
              </li>
              <li>
                <a href="<?php echo base_url() . 'admin/laporan_pengajuan_belum_verif' ?>">
                  <i class="glyphicon glyphicon-list-all"></i>Laporan Data Pengajuan Belum Verifikasi
                </a>
              </li>
              <li>
                <a href="<?php echo base_url() . 'admin/laporan_pengajuan_verif' ?>">
                  <i class="glyphicon glyphicon-list-all"></i>Laporan Data Pengajuan Verifikasi
                </a>
              </li>
              <li>
              <li>
                <a href="<?php echo base_url() . 'admin/cetak_laporan_mahasiswa' ?>">
                  <i class="glyphicon glyphicon-list-all"></i>Laporan Data mahasiswa
                </a>
              </li>
            </ul>
          </li>
