...
<div class="row">
    ...
    <div class="panel panel-success">
      <div class="panel-heading">
        <div class="row">
          ...
          <div class="col-xs-9 text-right">
            <div class="huge">
              <font size="18"><b><?php echo $this->M_perpus->get_data('prodi')->num_rows(); ?></b></font>
            </div>
            <div><b>Jumlah Prodi yang terdaftar</b></div>
          </div>
        </div>
      </div>
  ...
  <div class="col-lg-3 col-md-6">
    <div class="panel panel-warning">
      ...
      <a href="<?php echo base_url() . 'admin/pengajuan_sudah_verif' ?>">
        <div class="panel-footer">
          <span class="pull-left">View Details</span>
          <span class="pull-right"><i class="glyphicon glyphicon-arrow-right"></i></span>
          <div class="clearfix"></div>
  ...
  <div class="col-lg-3 col-md-6">
    <div class="panel panel-danger">
      ...
      <a href="<?php echo base_url() . 'admin/pengajuan_belum_verif' ?>">
        <div class="panel-footer">
          <span class="pull-left">View Details</span>
          <span class="pull-right"><i class="glyphicon glyphicon-arrow-right"></i></span>
          <div class="clearfix"></div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="text-right">
          <a href="<?php echo base_url() . 'admin/pengajuan' ?>">Lihat Semua Pengajuan <i class="glyphicon glyphicon-arrow-right"></i></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-3">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="text-right">
          <a href="<?php echo base_url() . 'admin/mahasiswa' ?>"> Lihat Semua mahasiswa <i class="glyphicon glyphicon-arrow-right"></i></a>
        </div>
      </div>
    </div>
  </div>
